...
export const canteens = [
  {
    ...
    name:        'Ball 1 Canteen',
    shortName:   'Ball 1',
    upiVpa:      process.env.REACT_APP_BALL1_UPI   || 'ball1canteen@upi',
  ...
  },
  {
    ...
    name:        'Ball 2 Canteen',
    shortName:   'Ball 2',
    upiVpa:      process.env.REACT_APP_BALL2_UPI   || 'ball2canteen@upi',
  ...
  },
  {
    ...
    shortName:   'Pencil 1',
    upiVpa:      process.env.REACT_APP_PENCIL1_UPI || 'pencil1canteen@upi',
